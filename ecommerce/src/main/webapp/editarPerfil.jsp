        ...
        <main>
            <section>
                <div class="rectangulo-centro">
                    ...
                    <input type="text" placeholder="Brhadaranyakopanishadvivekachudamani Erreh Muñoz">
                    <h3 class="perfil">Teléfono</h3>
                    <input type="text" placeholder="1234567890">
                    <h3 class="perfil">Dirección</h3>
                    <input type="text" placeholder="Enrique Segoviano">
                    <h3 class="perfil">Correo Electrónico</h3>
                    <input type="email" placeholder="a@gmail.com">
                    <h3 class="perfil">Contraseña</h3>
                    <input type="password" placeholder="*********">
                    <div class="centro-botton">
                        <button href="../html/perfil.html">Modificar</button>
                    </div>
                </div>
            </section>
        </main>
