...
public class Pedido implements Serializable {
    ...
    public Pedido(Long id, Usuario usuario, LocalDateTime fechaPedido, String estado, Double total, List<DetallesPedido> detalles) {
        this.id = id;
    ...
    public Pedido(Usuario usuario, LocalDateTime fechaPedido, String estado, Double total, List<DetallesPedido> detalles) {
        this.usuario = usuario;
        this.fechaPedido = fechaPedido;
        this.estado = estado;
        this.total = total;
